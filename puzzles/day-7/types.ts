 ...
 * Three of a kind,
 *  where three cards have the same label, and the remaining two cards are each different from
 *  any other card in the hand: TTT98
 * Two pair,
 *  where two cards share one label, two other cards share a second label, and the remaining card
